...
function binarySearch(id, array) {
    ...
    // while (!record) {
    //     if (subArray[midpoint].id === id) {
    //         record = subArray[midpoint];
    //     } else if (id < subArray[midpoint].id) {
    //         subArray = subArray.slice(0, midpoint);
    //     } else if (id > subArray[midpoint].id) {
    //         subArray = subArray.slice(midpoint, subArray.length);
    //     }
